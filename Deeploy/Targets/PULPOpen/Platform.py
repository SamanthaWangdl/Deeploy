...
from Deeploy.Targets.PULPOpen.Parsers import PULPAveragePool2DParser, PULPConv1DParser, PULPConv2DParser, \
    PULPDWConv1DParser, PULPDWConv2DParser, PULPFPConv2DParser, PULPFPDWConv2DParser, PULPGEMMParser, \
    PULPMatrixVecParser, PULPPWConv2DParser, PULPReduceMeanParser, PULPStemConv2DParser, PULPTallGEMMParser
...
AveragePool2DMapper = NodeMapper(PULPAveragePool2DParser(), PULPAveragePool2DTilingReadyBindings)
AveragePoolGrad2DMapper = NodeMapper(PULPAveragePool2DParser(), PULPAveragePoolGrad2DTilingReadyBindings)
